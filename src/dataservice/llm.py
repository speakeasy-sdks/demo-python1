...
class Llm:
    ...
    def log_llm(self, request: components.LLMValidateRequest) -> operations.LogLlmResponse:
        ...
        res = operations.LogLlmResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def evaluate(self, request: operations.EvaluateRequest) -> operations.EvaluateResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.EvaluateRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.EvaluateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list_metrics(self) -> operations.ListMetricsResponse:
        ...
        res = operations.ListMetricsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def validate_llm(self, request: operations.ValidateLlmRequest) -> operations.ValidateLlmResponse:
        ...
        if data is None and form is None:
            raise Exception('request body is required')
        query_params = { **utils.get_query_params(operations.ValidateLlmRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.ValidateLlmResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
